...
public final class LayoutToolbarBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageButton btnAccion;

  @NonNull
  public final MaterialToolbar toolbar;

  private LayoutToolbarBinding(@NonNull MaterialToolbar rootView, @NonNull ImageButton btnAccion,
  ...
  public static LayoutToolbarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.btnAccion;
      ImageButton btnAccion = ViewBindings.findChildViewById(rootView, id);
      if (btnAccion == null) {
        break missingId;
      }
      ...
      return new LayoutToolbarBinding((MaterialToolbar) rootView, btnAccion, toolbar);
    }
